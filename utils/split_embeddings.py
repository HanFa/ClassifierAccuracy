...
if __name__ == '__main__':
    ...
    filtered_identity = list(map(lambda x: x[0], filter(lambda x: x[1] >= 105, counter.items())))
    ...
    train_datasizes = [1, 2, 3, 4, 5, 10, 25, 50, 100]
    ...
    for train_datasize in tqdm(train_datasizes):
        print('preparing training set with cluster size {}'.format(train_datasize))
